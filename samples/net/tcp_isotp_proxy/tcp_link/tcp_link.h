 ...
 * The TCP Link module supports sending messages with headers, payloads,
 * and end-of-message sequences to ensure proper message framing.
 */
#pragma once
...
#define TCP_LINK_TX_BUFFER_SIZE (sizeof(struct tcp_link_tx_hdr) \
				+ CONFIG_TCP_LINK_TX_MAX_PAYLOAD_SIZE \
